...
<script type='text/php'>
    ...
    <table class="cert_table" style="width: 100%;">
        <td style="width: 20%;">
            <img src="logo-left.png" alt="">
        </td>
        <td>
        ...
        <td  style="width: 20%;">
            <img src="logo-right.png" alt="">
        </td>
    </table>

    <table style="table-layout: fixed;width: 100%;border-bottom: 4px groove #000000a6;padding-bottom: 21px;margin-bottom: 17px;">
        <tr>
            <td class="th_heading">
                Premises Number(s)
            </td>
        ...
        <tr>
            <td class="th_heading" style="padding-top: 18px;">
    ...
    <table class="attendees_table" style="width: 100%;border-bottom: 4px groove #000000a6;padding-bottom: 21px;margin-bottom: 17px;">
        <tr>
            <th class="attendes_title" colspan="2">
                attendees
            </th>
        </tr>
        <tr>
        ...
        <tr>
            <td class="th_heading" style="width: 220px; padding-top: 20px;">
    ...
    <div class="form_data">
        ...
        <table class="formdata_table" style="width: 100%;border-collapse: collapse;" border="1" cellspacing="0" cellpadding="8">
            ...
            <tr>
                <td class="title_left" style="width: 25%;">
                    Shopfront
                </td>
                <td class="value td_value" style="width: 25%;">
        ...
        <table  style="width: 100%;border-collapse: collapse;margin-top: 30px" border="1" cellspacing="0" cellpadding="8">
            ...
            <tr>
                ...
                <td style="width: 33%;"> Invetor's Authorised Signatory</td>
    ...
    <div class="footer" style="margin-top: 5em">
        <div class="">Copy to</div>
        <div class="">Chief operating officer</div>
        <div class="">General Manager - Leasing</div>
        <div class="">General Manager - OPerations & Marketing</div>
        <div class="">General Manager - Retail Design & Delivery</div>
        <div class="">Center Manager</div>
    </div>
</body>
</html>