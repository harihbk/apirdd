...
class InsuranceSubmissionRemainder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'insurancesubmission:remainder';
     ...
     * @var string
     */
    protected $description = 'Remainder for submitting Insurance before 2 weeks';
    ...
    {
        $date_limit = Carbon::today()->addDays(14);
        ...
        for($i=0;$i<count($projectDetails);$i++)
         {
                ...
                Mail::send('reminders.insurancesubmissionremainder', $emaildata, function($message)use($emaildata,$to,$cc) {
                    $message->to($to)
                            ->cc($cc)
                            ->subject($emaildata['unit_name']."-".$emaildata['investor_brand']."-".$emaildata['property_name']."-Insurance Remainder");

                        //    ->subject($emaildata['unit_name']."-".$emaildata['property_name']."-".$emaildata['project_name']."-Insurance_Remainder");
                    }); 
         }
