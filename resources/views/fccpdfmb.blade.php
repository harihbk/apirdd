...
<script type='text/php'>
    ...
    <table class="attendees_table" style="table-layout: fixed;width: 100%;border-bottom: 4px groove #000000a6;padding-bottom: 21px;margin-bottom: 17px;">
        <tr>
    ...
    <div class="form_data">
        ...
        <table  style="table-layout: fixed;width: 100%;border-collapse: collapse;margin-top: 30px" border="1" cellspacing="0" cellpadding="5">
            <tr>
        ...
        <table  style="table-layout: fixed;width: 100%;border-collapse: collapse;margin-top: 30px" border="0" cellspacing="0" cellpadding="5" >
            <tr>
